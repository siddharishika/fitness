  ...
  return (
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
        ...
        {userIsCoach && (
          <Button variant="light" style={submitBtnStyle} onClick={handleAddVideo}>
            Add Video
          </Button>
        )}
      </div>
              ...
              return (
                ...
                >
                    ...
                    <div style={{ color: '#f4f4f8' }}>
                      <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
                        ...
                        <h5 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }}>
                          Ratings:
                          {vid.currentRating > 0 ? (
                            <span style={{ display: 'flex', gap: '6px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
                              {[...Array(Math.round(vid.currentRating))].map((_, i) => (
                  ...
                  {/* <Card.Footer style={{ display: 'flex', gap: '8px' }}>
                    <button onClick={() => handleShowVideo(vid)} style={{ cursor: 'pointer' }}>Show</button>
                    <button onClick={() => handleEdit(vid)} style={{ cursor: 'pointer' }}>Edit</button>
                    <button onClick={() => handleDelete(vid)} style={{ cursor: 'pointer', color: 'red' }}>Delete</button>
                  </Card.Footer> */}
                </Card>
              );
            })}
        ...
        <div style={{ padding: '20px' }}>
          <Card style={{ border: '2px solid #A7C7E7', backgroundColor: '#161823' }}>
            <Card.Body>
              ...
              <Card.Text style={{ color: '#f4f4f8' }}>Upload videos to see them here.</Card.Text>
              {userIsCoach && (
                <Button variant="light" style={submitBtnStyle} onClick={handleAddVideo}>
                  Add Video
                </Button>
